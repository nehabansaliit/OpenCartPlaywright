...
async function performRegistration(page: Page): Promise<string> {
    ...
    await registrationPage.setPrivatePolicy();  // Accept the privacy policy
...
async function performLogin(page: Page, email: string) {
    ...
    await loginPage.setEmail(email);  // Use the registered credentials
...
async function addProductToCart(page: Page) {
    ...
    expect(await searchResultsPage.isSearchPageExists()).toBeTruthy();
